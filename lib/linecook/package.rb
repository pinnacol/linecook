...
module Linecook
  class Package
    ...
    # An array of sources generated by self (used to cleanup on close)
    attr_reader :sources
    ...
    def add(target_path, options={})
      ...
      register target_path, source
      on_export target_path, {:move => true}.merge(options)
    ...
    def close
      (sources + callbacks.values).each do |io|
